...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference("Ability.count") do
      post abilities_url, params: { ability: { effect: @ability.effect, id: @ability.id, name: @ability.name } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { effect: @ability.effect, id: @ability.id, name: @ability.name } }
